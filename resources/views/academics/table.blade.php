        ...
        @foreach($academics as $academic)
            <tr>
                ...
                <td>
                    ...
                    <div class='btn-group'>
                        <a data-toggle="modal" data-target="#academic-view-modal" data-academic_id="{{ $academic->academic_id }}" data-academic_year="{{ $academic->academic_year }}" data-created_at="{{ $academic->created_at }}" data-updated_at="{{ $academic->updated_at }}" class='btn btn-default btn-xs'>
